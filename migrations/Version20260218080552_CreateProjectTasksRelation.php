 ...
 */
final class Version20260218080552_CreateProjectTasksRelation extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create project tasks relation (one-to-many optional relation)';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__tasks AS SELECT id, title, description, created_by, last_modified_by FROM tasks');
        ...
        $this->addSql('INSERT INTO tasks (id, title, description, created_by, last_modified_by) SELECT id, title, description, created_by, last_modified_by FROM __temp__tasks');
